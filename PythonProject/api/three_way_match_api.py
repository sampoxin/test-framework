...
class ThreeWayMatchApi(BaseApi):
    ...
    def collect_invoice(self, invoice_no: str) -> dict:
        """按发票号码收取发票"""
        return self._post(f"{self._INVOICE}/collect/byNo", json={"invoiceNo": invoice_no})

    def page_invoices(self, page_num: int = 1, page_size: int = 10, **filters) -> dict:
        """分页查询发票列表，支持任意筛选条件"""
        params = {"pageNum": page_num, "pageSize": page_size, **filters}
        return self._post(f"{self._INVOICE}/page", json=params)

    def get_invoice_detail(self, invoice_id) -> dict:
        """获取发票详情"""
        return self._get(f"{self._INVOICE}/detail/{invoice_id}")
    ...
    def page_matches(self, page_num: int = 1, page_size: int = 10, **filters) -> dict:
        ...
        params = {"pageNum": page_num, "pageSize": page_size, **filters}
        return self._post(f"{self._MATCH}/page", json=params)
    ...
    def audit_invoice(self, invoice_id, audit_status: int = 2) -> dict:
        ...
        return self._post(f"{self._MATCH}/audit", json={"id": invoice_id, "auditStatus": audit_status})

    def batch_audit(self, invoice_ids: list) -> dict:
        """批量审核发票"""
        return self._post(f"{self._MATCH}/batchAudit", json={"invoiceIds": invoice_ids})
    ...
    def batch_manual_match(self, match_data_list: list, supplier_id=None) -> dict:
        ...
        return self._post(f"{self._MATCH}/manual-match/batch", json=params)
    ...
    def approve(self, match_id, approved: bool, supplier_id=None, remark: str = "") -> dict:
        ...
        return self._post(f"{self._MATCH}/approval", json=params)
    ...
    def batch_approve(self, approval_data_list: list) -> dict:
        ...
        """
        return self._post(f"{self._MATCH}/approval/batch", json={"approvalDataList": approval_data_list})
    ...
    def cancel(self, match_ids: list, supplier_id=None) -> dict:
        ...
        if supplier_id:
            params["supplierId"] = supplier_id
        return self._post(f"{self._MATCH}/cancel", json=params)
    ...
    def edit_item_code(self, match_id, supplier_id, items: list, order_nos: list = None, return_order_nos: list = None) -> dict:
        ...
        return self._post(f"{self._MATCH}/item-code", json=params)

    def get_item_units(self, supplier_id, item_code: str) -> dict:
        """查询商品代码的单位信息"""
        return self._post(f"{self._MATCH}/item-units", json={"supplierId": supplier_id, "itemCode": item_code})

    # ==================== 抵扣明细 ====================

    def get_expense_deductions(self, match_id) -> dict:
        """查看费用单抵扣明细"""
        return self._get(f"{self._MATCH}/{match_id}/expense-order-deductions")

    def get_pre_settlement_deductions(self, match_id) -> dict:
        """查看预付抵扣明细"""
        return self._get(f"{self._MATCH}/{match_id}/pre-settlement-deductions")

    def get_make_up_orders(self, match_id) -> dict:
        """查看乐檬扣补单明细"""
        return self._get(f"{self._MATCH}/{match_id}/make-up-orders")
    ...
    def push_settlement(self, match_id) -> dict:
        """单条推送结算单"""
        return self._post(f"{self._MATCH}/{match_id}/push-settlement", json={})
    ...
    def batch_push_settlement(self, match_ids: list = None, red_match_ids: list = None) -> dict:
        ...
        return self._post(f"{self._MATCH}/push-settlement/batch", json=params)
    ...
    def check_red_block(self, supplier_ids: list) -> dict:
        """查询未结算红票（红蓝对冲检查）"""
        return self._post(f"{self._MATCH}/push-settlement/red-block-check", json=list(supplier_ids))
    ...
    def get_supplier_options(self, keyword: str = None, limit: int = 20) -> dict:
        ...
        return self._post(f"{self._FORCE}/supplier-options", json=params)
    ...
    def page_unsettled(self, supplier_id, page_num: int = 1, page_size: int = 20,
        ...
        return self._post(f"{self._FORCE}/page-unsettled", json=params)
    ...
    def load_receipt_items(self, supplier_id, receipt_nos: list = None, return_nos: list = None) -> dict:
        ...
        if return_nos:
            params["returnNos"] = return_nos
        return self._post(f"{self._FORCE}/load-receipt-items", json=params)

    def check_invoice_summary(self, supplier_id, invoice_nos: list) -> dict:
        """校验发票信息（冲突检查）"""
        return self._post(f"{self._FORCE}/invoice-summary", json={
    ...
    def submit_force_match(self, supplier_id, invoice_nos: list, receipt_or_return_nos: list,
        ...
        if tab:
            params["tab"] = tab
        return self._post(f"{self._FORCE}/submit", json=params)

    def get_force_result(self, force_batch_no) -> dict:
        """查看强制匹配结果"""
        return self._get(f"{self._FORCE}/result/{force_batch_no}")
    ...
    def page_records(self, business_id, supplier_id=None, business_type: int = None,
        ...
        return self._post(f"{self._RECORD}/page", json=params)
